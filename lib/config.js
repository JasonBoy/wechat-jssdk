...
const wechatConfig = {
  ...
  paymentUrls: {
    ...
    SETTLEMENT_QUERY: 'https://api.mch.weixin.qq.com/pay/settlementquery',
    QUERY_EXCHANGE_RATE: 'https://api.mch.weixin.qq.com/pay/queryexchagerate', // yes this is correct, spelling "exchange" correctly is difficult 🤷️
  },
