...
class Payment {
   ...
   */
  generateSignature (params, sandbox) {
    ...
    str += '&key=' + this.getAPISignKey(sandbox);
    console.log(str);
  ...
  generatePaySign (prepayId, signType) {
    ...
    return this.generateGeneralPaymentSignature(params);
  }

  generateGeneralPaymentSignature(params, sandbox) {
