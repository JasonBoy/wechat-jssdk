...
class Payment {
  ...
  generateSignature (params, sandbox) {
    ...
    str += '&key=' + ((sandbox || !this.wechatConfig.paymentSandBox) ? this.wechatConfig.paymentKey : this.wechatConfig.paymentSandBoxKey );
    console.log(str);
  ...
  generateGeneralPaymentSignature(params) {
