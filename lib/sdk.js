      ...
      if(!forceWechatUpdate) {
        sdk.saveNewSignature(ret, null, function(err) {
          if(!err) {
            ...
            sdk.updateSignatureByUrl(query.signatureName, ret, function () {
