...
sdk.prepareNewSignature = function(callback) {
  var _gt = cache.globalToken.accessToken;
  if(!_gt || isTokenExpired(_gt)) {
 ...
 * @param callback
 */
sdk.saveNewSignature = function(info, callback) {
 ...
 */
sdk.createNewSignature = function(url, callback) {
  sdk.prepareNewSignature(function (result, data) {
    if(data.accessToken) {
      ...
      sdk.saveNewSignature(ret, function(err) {
        if(!err) {
