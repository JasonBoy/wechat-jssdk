...
sdk.updateAccessTokenOrTicketGlobally = function(token, ticket) {
  ...
  var globalToken = _.assign(cache.globalToken, info);
  globalToken.count++;
 ...
 * @returns {*}
 */
sdk.getSignatureByURL = function(url, forceNewSignature) {
...
sdk.getCachedWechatInfo = function() {
  return cache;
};
sdk.getCachedGlobalToken = function() {
  return cache.globalToken;
};
sdk.getCachedUrlSignature = function () {
  return cache.urls;
};
