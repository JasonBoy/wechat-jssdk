...
function init() {
  ...
  db.defaults({posts:[], orders: [], user: {}, count: 0})
    .write();
...
function getState() {
  ...
  console.log(db.get('posts').cloneDeep().value());
  console.log(db.get('posts').find({id: 1}).has('id2').value());
}
